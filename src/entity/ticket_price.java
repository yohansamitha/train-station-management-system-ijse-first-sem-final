...
public class ticket_price {
    ...
    public ticket_price(String ticket_price_ID, String station_ID, String route_ID, int st_class_seat_price1, int st_class_seat_price2, int st_class_seat_price3) {
